...
class ThemeManager extends ChangeNotifier {
  ...
  ThemeData get darkTheme {
    return ThemeData(
      ...
      scaffoldBackgroundColor: const Color(
        0xFF000000,
      ), // Pure black background like the design
      colorScheme: ColorScheme.fromSeed(
      ...
      switchTheme: SwitchThemeData(
        ...
        trackColor: WidgetStateProperty.resolveWith<Color>((states) {
          if (states.contains(WidgetState.selected)) {
            return const Color(
              0xFFFFC049,
            ).withValues(alpha: 0.3); // Accent with opacity when on
          }
  ...
  List<Color> get neumorphicGradient => _isDarkMode
      ? [
        ...
        ] // iOS-style dark mode cards - lighter grey for contrast against black
  ...
  Color get primaryTextColor => _isDarkMode
      ? const Color(
          0xFFFFFFFF,
        ) // Pure white for better contrast against grey cards
  ...
  Color get tertiaryTextColor =>
      _isDarkMode ? const Color(0xFF888888) : const Color(0xFF888888);

  /// Get background color for info containers
  Color get infoBackgroundColor =>
      _isDarkMode ? const Color(0xFF2A2A2A) : const Color(0xFFFFF8F0);
  ...
  Color get cardBorderColor =>
      _isDarkMode ? const Color(0xFF404040) : const Color(0xFFE0E0E0);

  /// Get disabled element color
  Color get disabledColor =>
      _isDarkMode ? const Color(0xFF444444) : const Color(0xFFD4D4D4);

  /// Get success/active indicator color
  Color get successColor =>
      _isDarkMode ? const Color(0xFF4CAF50) : const Color(0xFF4CAF50);

  /// Get error/warning indicator color
  Color get errorColor =>
      _isDarkMode ? const Color(0xFFEF5350) : const Color(0xFFEF5350);

  /// Get warning color
  Color get warningColor =>
      _isDarkMode ? const Color(0xFFFF9800) : const Color(0xFFFF9800);

  /// Get accent color variants for dark mode
  Color get accentColorDark =>
      const Color(0xFFFFB347); // Slightly warmer for dark backgrounds
  ...
  Color get currentAccentColor =>
      _isDarkMode ? accentColorDark : accentColorLight;
  ...
  Color get appBarElevationColor =>
  ...
  Color get dividerColor =>
      _isDarkMode ? const Color(0xFF383838) : const Color(0xFFE0E0E0);
}
